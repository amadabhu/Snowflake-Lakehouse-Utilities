COPY INTO REFINITIV.STAGING.STD_QUANT_ANN_XML FROM @REFINITIV.STAGING.Stage_STDQuantANN on_error = 'Continue';

CREATE TABLE REFINITIV.STAGING.STD_QUANT_ANN_LAYOUT AS
SELECT GET(XMLGET(XML,'RepNo'),'$')::STRING AS "RepNo"
       ,GET(FinancialsLayout.value,'@Type')::STRING AS "LayoutType"
       ,GET(FinancialsLayoutMapItem.value,'@Agg')::STRING AS "Agg"
       ,GET(FinancialsLayoutMapItem.value,'@COA')::STRING AS "COA"
       ,GET(FinancialsLayoutMapItem.value,'@Display')::STRING AS "Display"
       ,GET(FinancialsLayoutMapItem.value,'@Level')::STRING AS "Level"
       ,GET(FinancialsLayoutMapItem.value,'@LineID')::INTEGER AS "LineID"
       ,GET(FinancialsLayoutMapItem.value,'@Precision')::STRING AS "Precision"
       ,GET(FinancialsLayoutMapItem.value,'$')::STRING AS "Description"
FROM REFINITIV.STAGING.STD_QUANT_ANN_XML t
...
CREATE TABLE REFINITIV.STAGING.STD_QUANT_ANN_FV AS
SELECT GET(XMLGET(XML,'RepNo'),'$')::STRING AS "RepNo"
       ...
       ,GET(FinancialValues.value,'@COA')::STRING AS "COA"
...
TRUNCATE REFINITIV.PUBLIC.STD_QUANT_ANN_DATA;

INSERT INTO REFINITIV.PUBLIC.STD_QUANT_ANN_DATA
SELECT   A."RepNo"
		,A."CompanyName"
		,A."CompanyType"
		,A."ActiveStatus"
        ...
        ,B."LineID"
        ,B."Precision"
FROM REFINITIV.STAGING.STD_QUANT_ANN_FV A
INNER JOIN REFINITIV.STAGING.STD_QUANT_ANN_LAYOUT B
ON A."RepNo" = B."RepNo" AND
   A."StatementType" = B."LayoutType" AND
   A."COA" = B."COA";
   
DROP TABLE REFINITIV.STAGING.STD_QUANT_ANN_FV;

DROP TABLE REFINITIV.STAGING.STD_QUANT_ANN_LAYOUT;
