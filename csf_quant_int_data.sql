CREATE TABLE REFINITIV.STAGING.CSF_QUANT_INT_DATA_LAYOUT
 AS
...
FROM REFINITIV.STAGING.CSF_QUANT_INT_DATA_XML t
...
CREATE TABLE REFINITIV.STAGING.CSF_QUANT_INT_DATA_FV
AS
SELECT GET(XMLGET(XML,'RepNo'),'$')::STRING AS "RepNo"
...
CREATE TABLE REFINITIV.STAGING.CSF_QUANT_INT_DATA
AS
SELECT
 A."RepNo"
,A."CompanyName"
...
,B."COA"
,B."Display" 
FROM "REFINITIV"."STAGING"."CSF_QUANT_INT_DATA_FV" A
INNER JOIN "REFINITIV"."STAGING"."CSF_QUANT_INT_DATA_LAYOUT" B
