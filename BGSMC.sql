COPY INTO REFINITIV.STAGING.CUSTOMERS_XML FROM @REFINITIV.STAGING.Stage_BGSMC on_error = 'Continue';

CREATE OR REPLACE VIEW REFINITIV.STAGING.V_CUSTOMERS_STAGING AS 
...
INSERT INTO REFINITIV.PUBLIC.CUSTOMERS 
    SELECT * FROM REFINITIV.STAGING.V_CUSTOMERS_STAGING;
